...
public class Order {
    ...
    private String notes; // Added for delivery person
    ...
    public String getAcceptedByPhone() { return acceptedByPhone; }
    public void setAcceptedByPhone(String acceptedByPhone) { this.acceptedByPhone = acceptedByPhone; }
